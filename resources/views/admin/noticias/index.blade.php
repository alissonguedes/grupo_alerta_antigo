...
@section('content')
    ...
    <div class="responsive-table">
        ...
        <div class="top flex mb-1">
            ...
            <div class="actions action-btns flex flex-col align-itens-center">
                ...
                <div class="show-buttons">
                    <button type="button" class="btn btn-large waves-effect" data-href="{{ route('admin.noticias.add') }}" data-tooltip="Adicionar">
        ...
        <div class="content">
            ...
            <table class="table dataTable no-footer" data-link="{{ route('admin.noticias') }}">
                <thead>
                    <tr>
