				...
				<nav id="site-navigation" class="main-navigation dsvy-navbar  dsvy-main-active-color-globalcolor dsvy-dropdown-active-color-globalcolor" aria-label="Top Menu">
					<div class="menu-main-menu-container">
						...
						<ul id="dsvy-top-menu" class="menu">
							...
							<li id="menu-item-12616" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-12616">
								<a href="#">Empresas do Grupo</a>
								<ul class="sub-menu">
									<li id="menu-item-13653" class="menu-item menu-item-type-post_type menu-item-object-dsvy-service menu-item-13653">
										<a href="alertaeletronica.php">Alerta Segurança Eletônica</a>
									</li>

									<li id="menu-item-13653" class="menu-item menu-item-type-post_type menu-item-object-dsvy-service menu-item-13653">
										<a href="alertaservicos.php">Alerta Serviços</a>
									</li>

									<li id="menu-item-13653" class="menu-item menu-item-type-post_type menu-item-object-dsvy-service menu-item-13653">
										<a href="forcaalerta.php">Força Alerta</a>
									</li>

									<li id="menu-item-13653" class="menu-item menu-item-type-post_type menu-item-object-dsvy-service menu-item-13653">
										<a href="alertaconstrutora.php">Alerta Construtora</a>
									</li>

									<li id="menu-item-13653" class="menu-item menu-item-type-post_type menu-item-object-dsvy-service menu-item-13653">
										<a href="portariavirtual.php">Alerta Portaria Virtual</a>
									</li>

									<li id="menu-item-13653" class="menu-item menu-item-type-post_type menu-item-object-dsvy-service menu-item-13653">
										<a href="segurancavalores.php">Força Alerta Segurança e Transporte de Valores</a>
									</li>
								</ul>
							</li>
							...
							<li id="menu-item-12615" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-12615">
								<a href="http://app1srv.ddns.com.br:9596/portalservice/" target="_blank">Área do Cliente</a>
							</li>
